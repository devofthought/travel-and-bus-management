...
router.patch('/:id', (0, validateRequest_1.default)(driver_validation_1.DriverValidation.updateDriverZodSchema), driver_controller_1.DriverController.updateDriver);
